...
public class MenuFrame extends JFrame {
	...
	public MenuFrame() throws HeadlessException{
	    ...
	    setDefaultCloseOperation(DISPOSE_ON_CLOSE);
         ...
         JLabel GamePanelStartInstructions= new JLabel (" Naciśnij przycisk żeby rozpocząć");
         GamePanelStartInstructions.setFont(new Font("Comic Sans", Font.BOLD, 14));
         GamePanelStartInstructions.add(GamePanelStartInstructions);
